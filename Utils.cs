...
namespace ClinicManagementSystem
{
    public class Utils
    {
        public static Dictionary<int, string> GetSlots()
        {
            ...
            slots.Add(2, "Slot 2: From 6:30 PH to 7:00 PM");
            slots.Add(3, "Slot 3: From 7:00 PM to 7:30 PM");
            slots.Add(4, "Slot 4: From 7:40 PM to 8:00 PM");
            slots.Add(5, "Slot 5: From 8:00 PM to 8:30 PM");
            slots.Add(6, "Slot 6: From 8:00 PM to 9:00 PM");
            slots.Add(7, "Slot 7: From 9:00 PM to 9:30 PM");
            slots.Add(8, "Slot 8: From 9:30 PH to 10:00 PM");
            slots.Add(9, "Slot 9: From 10:00 PH to 10:30 PM");
        ...
        public static void CreateAdmin(string password)
        {
            ...
            command.CommandText = "INSERT INTO users_clinic (user_username, user_password) VALUES (@username, @password)";
